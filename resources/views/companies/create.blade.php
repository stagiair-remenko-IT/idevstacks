            ...
            <form method="POST" action="{{ route('companies.store') }}" class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="notes" name="notes" rows="4"
                              class="mt-1 block w-full rounded-lg bg-slate-700/50 border-slate-600 text-white placeholder-slate-500 focus:border-indigo-500 focus:ring-indigo-500">{{ old('notes') }}</textarea>
                </div>
